...
class PersistentSlidingUpPanel extends StatefulWidget {
  /// Child widget
  final Widget child;
  ...
  const PersistentSlidingUpPanel({
    super.key,
    required this.child,
  ...
  State<StatefulWidget> createState() {
    return _PersistentSlidingUpPanelState();
  }

  static PersistentSlidingUpPanel? of(BuildContext context) {
    return context.findAncestorWidgetOfExactType<PersistentSlidingUpPanel>();
  }

  /// Creates an animation controller suitable for controlling a [PersistentSlidingUpPanel].
...
class _PersistentSlidingUpPanelState extends State<PersistentSlidingUpPanel>
    with SingleTickerProviderStateMixin<PersistentSlidingUpPanel> {
  ...
  void initState() {
    ...
    if (widget.animationController == null) {
      _animationController =
          PersistentSlidingUpPanel.createAnimationController(this);
    } else {
